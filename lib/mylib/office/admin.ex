defmodule Mylib.Office.Admin do
  use Ecto.Schema
  ...
  schema "admins" do
    ...
    has_one :admin_profile, Mylib.Office.AdminProfile
  ...
  """
  def valid_password?(%Mylib.Office.Admin{hashed_password: hashed_password}, password)
